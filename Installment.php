...
<html lang="ar" dir="rtl">
    <head>
        ...
        <script type="text/javascript">  
            function printPage(){  
                // احصل على كود html للصفحة الحالية  
                var bodyhtml = window.document.body.innerHTML;  
                            // قم بتعيين منطقة بداية الطباعة ومنطقة النهاية  
        ...
        <div id="main" style="padding: 5px;">
            <div class="page_invoce" style="border: 1px solid #000;border-radius: 10px;padding: 30px;">
                <div class="Heading_info flex">
                    <div class="Logo center"><span class="NameSite">متجر ميتا ستور</span> </div>
                    <div class="Logo center"><img style="width: 100px;" src="uploads/125880420_8054567753_3398744478_taroisa.png"></div>
                    <div class="Logo center"><span class="NameSite">META STORE</span> </div>
                </div>
                ...
                <div class="table" style="margin-top: 10px;">
                    <div class="text_info_table" >
                        ...
                        <p>أقر وأعترف وأنا في حالتي الشرعية وبكامل قواي العقلية بأن في ذمتي للمؤسسة المدعوة/ ميتا ستور مبلغ وقدره/ (<?= $totel_price ?>) ريال فقط. وذلك عن ما تبقى من ثمن جهاز/ <?= $name_pro ?> على ان يدفع المبلغ على اقساط متتالية بما فيها شهر رمضان والأعياد</p>
                        <p>قيمة الدفعة الشهرية/ (<?= intval($batch) ?>) ريال فقط اعتباراً من تاريخ/ الى نهاية المبلغ المذكور اعلاه وأنني اتعهد بسداد الأقساط في موعدها بدون تأخر عن أي قسط عن موعده المحدد فإنني ملتزم إلتزاماً بسداد المبلغ المتبقي كاملاً دفعة واحدة.</p>
                        <p>كما أنني اقر على نفسي بأنه لايوجد إلتزامات مالية ولا كفالات غرامية وقد اذنت والله خير الشهادين</p>
                    </div>
                </div>
                <div class="info_customer flex" style="align-items: flex-start;">
                    ...
                    <div>
                        <div style="text-align: left;"><img style="width: 60px;margin: 0px 35px;transform: rotate(-20deg);" src="uploads/seal.png"> </div>
                    </div>
                </div></div>
                    </div>
                </div>

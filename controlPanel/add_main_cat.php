...
include "master.php";
 ...
 <?php
   ...
   if(isset($_POST['btnAdd'])){
    ...
    $sql = "INSERT INTO `main_cat` (`title`,`image`,`url`) VALUES ('$title','$image_name','$url')";
    $rs = $db->dbQuery($sql);
 ...
 <div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      ...
      <h4 class="header-title m-t-0 m-b-30">اضافة قائمة جديدة</h4>
        ...
        <div class="col-lg-6">
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" required  name="title"  placeholder="اسم القائمة  ">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control"  name="url"  placeholder="رابط القائمة    ">
                      </div>

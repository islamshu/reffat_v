 ...
 $row = $db->dbFetchRecord($rs);
   if(isset($_POST['btnAdd'])){
    $review = $_POST['review'];
      ...
      $sql = "UPDATE `users` SET review = $review WHERE `users`.`id` = $id";
      $rs = $db->dbQuery($sql);
          ...
          ';
          echo "<meta http-equiv='refresh' content='3;URL=eidt-aldariba.php'>";
 ...
 <div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      ...
      <h4 class="header-title m-t-0 m-b-30">تعديل السجل التجاري</h4>
        ...
        <div class="col-lg-6">
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <label class="" style="display: block;text-align: center;">السجل التجاري</label>
                          <input type="text" class="form-control" value="<?= $row['review'] ?>"  name="review" >
                      </div>

            ...
            <div class="page_invoce" style="border: 1px solid #000;border-radius: 10px;padding: 30px;">
                ...
                <div class="info_customer flex" style="align-items: flex-start;">
                    <div class="info_cus">
                        ...
                        <div><span>البريد الاكتورني  : </span> <?= $email ?> </div>
                        <div><span>رقم الواتس اب : </span> <?= $phone ?> </div>
                        <div><span>الدولة  : </span> <?= $country ?> </div>
                        <div><span>المدينة  : </span> <?= $city ?> </div>
                    </div>
                    <div class="info_cus">
                        ...
                        <div><span>اسم العميل : </span> <?= $name ?> </div>
                        <div><span>رقم الهاتف : </span> <?= $phone ?> </div>
                        <div><span>الحي  : </span> <?= $location ?> </div>
                        <div><span>الشارع  : </span> <?= $street ?> </div>
                        <div><span>البيت  : </span> <?= $home ?> </div>
                        <div><span>الرمز البريدي  : </span> <?= $zip ?> </div>
                                            ...
                                            if($db->dbNumRows($result)){
                                                ...
                                                foreach($rows as $rowp){ 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <?= $rowp['name'] ?> </td>
                                                        <td> <?= $row['quantity'] ?> </td>
                                                        <td> <?= $rowp['dec'] == 0 ? $rowp['price'] * $row['quantity'] : $rowp['price']-$rowp['dec'] * $row['quantity']?> </td>
                                                    </tr>  
                                                <?php }
                                            }
                                        }

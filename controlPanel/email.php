 ...
 $row_r = $db->dbFetchRecord($rs);
   ...
   if(isset($_POST['btnAdd'])){
     ...
     $email = $_POST['email'];
        ...
        $sql = "UPDATE `users` SET `email` = '$email' WHERE `users`.`id` = 2";
        $rs = $db->dbQuery($sql);
 ...
 <div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      ...
      <h4 class="header-title m-t-0 m-b-30">نعديل ايميل</h4>
        ...
        <div class="col-lg-6">
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          <label class="" style="display: block;text-align: center;">ايميل</label>
                          <input dir="ltr" type="text" class="form-control" value="<?= $row_r['email'] ?>"  name="email" >
                      </div>

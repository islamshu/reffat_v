    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center p-2">
            ...
            <div class="">
                ...
                <p style="font-size: 14px;">الدفع بواسطة <img src="assets/image/icons/tmara.png" width="70" height="30" style="object-fit: cover;" alt=""></p>
            </div>
        ...
        <section class="container-fluid mt-3">
            <div class="row">
                ...
                <div class=" col-md-5 col-11   px-4 py-1 my-md-5 my-3 main-confirm" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px;background-color:white;border-radius:15px;margin-top:0 !important;margin-bottom:20px ! important">
                    ...
                    <form action="checkoutTmara.php?totalPrice=<?= $totalPrice ?>" method="POST" class="pb-2">
